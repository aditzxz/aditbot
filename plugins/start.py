    ...
    if len(text)>7:
        ...
        if len(argument) == 3:
            ...
            try:
                ...
                return
        temp_msg = await message.reply("Tungguin Jangan Spam...")
        try:
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("☎️ Tentangku", callback_data = "teantangku"),
                    InlineKeyboardButton("🔒close aja", callback_data = "close")
                ]
            ]
        )
