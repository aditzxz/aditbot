...
async def channel_post(client: Client, message: Message):
    ...
    reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("🔁 Share Link Anda", url=f'https://telegram.me/share/url?url={link}')]])

    await reply_text.edit(f"<b>🔱 Link Vidio</b>\n{link}", reply_markup=reply_markup, disable_web_page_preview = True)
